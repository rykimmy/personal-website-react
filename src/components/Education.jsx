            ...
            */}
            ...
            <div className="edu">
                <div className="educationitem">
                    <img className="schoolimg" src="dartmouthlogo_original.jpeg" />

                    <div className="schoolinfo">
                        <h2 className="itemtitle">Dartmouth College</h2>
                        <h4 className="itemdescription">B.A. in Computer Science modified with<br></br>Human Centered Design</h4>
                ...
                <div className="educationitem">
                    <img className="schoolimg" src="choatelogo.jpg" />
